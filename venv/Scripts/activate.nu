...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\100 Days of Code  the complete Python Bootcamp\Day 66-RESTful-blog-start\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\100 Days of Code  the complete Python Bootcamp\Day 66-RESTful-blog-start\venv\Scripts\deactivate.nu'
